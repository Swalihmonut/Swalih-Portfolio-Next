                ...
                <div className="pricing14-price10">
                  <div className="pricing14-price11">
                    <p className="pricing14-text107 thq-body-large">
                      {props.plan1 ?? (
                        <Fragment>
                          <span className="pricing14-text193">Basic Plan</span>
                        </Fragment>
                      )}
                    </p>
                    <h3 className="pricing14-text108 thq-heading-3">
                      {props.plan1Price ?? (
                        <Fragment>
                          <span className="pricing14-text169">$99/month</span>
                        </Fragment>
                      )}
                    </h3>
                    <p className="thq-body-large">
                      {props.plan1Yearly ?? (
                        <Fragment>
                          <span className="pricing14-text203">$999/year</span>
                        </Fragment>
                      )}
                    </p>
                  </div>
                ...
                <div className="pricing14-price12">
                  <div className="pricing14-price13">
                    ...
                    <h3 className="pricing14-text115 thq-heading-3">
                      {props.plan2Price ?? (
                        <Fragment>
                          <span className="pricing14-text186">$199/month</span>
                        </Fragment>
                      )}
                    </h3>
                    <p className="thq-body-large">
                      {props.plan2Yearly ?? (
                        <Fragment>
                          <span className="pricing14-text195">$1999/year</span>
                        </Fragment>
                      )}
                    </p>
                  </div>
              ...
              <div className="pricing14-column3 thq-card">
                <div className="pricing14-price14">
                  <div className="pricing14-price15">
                    ...
                    <h3 className="pricing14-text123 thq-heading-3">
                      {props.plan3Price ?? (
                        <Fragment>
                          <span className="pricing14-text161">$299/month</span>
                        </Fragment>
                      )}
                    </h3>
                    <p className="thq-body-large">
                      {props.plan3Yearly ?? (
                        <Fragment>
                          <span className="pricing14-text170">$2999/year</span>
                        </Fragment>
                      )}
                    </p>
                  </div>
                        ...
                        {props.plan3Feature5 ?? (
                          <Fragment>
                            <span className="pricing14-text194">
                              Extensive Experience in Life Sciences
                ...
                <button className="pricing14-button16 thq-button-filled thq-button-animated">
                  <span className="thq-body-small">
                    {props.plan3Action ?? (
                      <Fragment>
                        <span className="pricing14-text190">Sign Up Now</span>
                      </Fragment>
                    )}
                  </span>
                </button>
                ...
                <div className="pricing14-price16">
                  <div className="pricing14-price17">
                    <span className="pricing14-text131 thq-body-large">
                      {props.plan11 ?? (
                        <Fragment>
                          <span className="pricing14-text204">Basic plan</span>
                        </Fragment>
                      )}
                    </span>
                    <h3 className="pricing14-text132 thq-heading-3">
                      {props.plan1Price1 ?? (
                        <Fragment>
                          <span className="pricing14-text171">$199/month</span>
                        </Fragment>
                      )}
                    </h3>
                    <span className="thq-body-large">
                      {props.plan1Yearly1 ?? (
                        <Fragment>
                          <span className="pricing14-text173">$1999/year</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                ...
                <div className="pricing14-price18">
                  <div className="pricing14-price19">
                    ...
                    <h3 className="pricing14-text139 thq-heading-3">
                      {props.plan2Price1 ?? (
                        <Fragment>
                          <span className="pricing14-text167">$299/month</span>
                        </Fragment>
                      )}
                    </h3>
                    <span className="thq-body-large">
                      {props.plan2Yearly1 ?? (
                        <Fragment>
                          <span className="pricing14-text166">$2999/year</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                ...
                <div className="pricing14-price20">
                  <div className="pricing14-price21">
                    ...
                    <h3 className="pricing14-text147 thq-heading-3">
                      {props.plan3Price1 ?? (
                        <Fragment>
                          <span className="pricing14-text160">$399/month</span>
                        </Fragment>
                      )}
                    </h3>
                    <span className="thq-body-large">
                      {props.plan3Yearly1 ?? (
                        <Fragment>
                          <span className="pricing14-text156">$3999/year</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                        ...
                        {props.plan3Feature11 ?? (
                          <Fragment>
                            <span className="pricing14-text179">
                              GitHub Integration with Detailed Project Showcase
                              using STAR Methodology
                            </span>
                          </Fragment>
                        )}
                      </span>
                        ...
                        {props.plan3Feature21 ?? (
                          <Fragment>
                            <span className="pricing14-text182">
                              Embedded Visuals for Enhanced Presentation of
                              Insights
                            </span>
                          </Fragment>
                        )}
                        ...
                        {props.plan3Feature31 ?? (
                          <Fragment>
                            <span className="pricing14-text191">
                              ...
                              Regulations&apos; Highlighted Expertise
                            </span>
                          </Fragment>
                        )}
                      </span>
