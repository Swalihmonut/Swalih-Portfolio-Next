          ...
          <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
            <nav className="navbar8-links1">
              ...
              <a href={props.link2Url} className="thq-body-small thq-link">
                {props.link2 ?? (
                  <Fragment>
                    <span className="navbar8-text18">Portfolio</span>
                  </Fragment>
                )}
              </a>
              <a
              ...
              >
                {props.link3 ?? (
                  <Fragment>
                    <span className="navbar8-text14">Skills</span>
                  </Fragment>
                )}
              </a>
              <div
                              ...
                              {props.page2Description ?? (
                                <Fragment>
                                  <span className="navbar8-text16">
                                    Detailed projects showcasing business impact
                        ...
                        <div className="navbar8-menu-item3">
                          ...
                          <div className="navbar8-content3">
                            <span className="navbar8-page31 thq-body-large">
                              {props.page3 ?? (
                                <Fragment>
                                  <span className="navbar8-text19">Skills</span>
                                </Fragment>
                              )}
                            </span>
                            <span className="thq-body-small">
                              {props.page3Description ?? (
                                <Fragment>
                                  <span className="navbar8-text17">
                                    Skills in BI tools, Python, compliance, and
                                    more
                                  </span>
                                </Fragment>
                              )}
...
Navbar8.defaultProps = {
  ...
  page1ImageAlt: 'image',
  logoAlt: 'Business Analyst Portfolio Logo',
