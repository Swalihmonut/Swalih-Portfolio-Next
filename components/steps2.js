            ...
            <div className="steps2-container3">
              <div className="steps2-container4 thq-card">
                <h2 className="thq-heading-2">
                  {props.step1Title ?? (
                    <Fragment>
                      <span className="steps2-text32">Initial Assessment</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text27">
                        Conduct a thorough analysis of the current business
                        processes and data infrastructure in the life sciences
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text30">
                        Utilize Power BI and Tableau to create interactive
                        dashboards and reports for key stakeholders, providing
              ...
              <div className="steps2-container6 thq-card">
                <h2 className="thq-heading-2">
                  {props.step3Title ?? (
                    <Fragment>
                      <span className="steps2-text28">AI/ML Integration</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text29">
                        Implement AI/ML algorithms to optimize production
                        processes, predictive maintenance, and quality control
              ...
              <div className="steps2-container7 thq-card">
                <h2 className="thq-heading-2">
                  {props.step4Title ?? (
                    <Fragment>
                      <span className="steps2-text25">Ensuring Compliance</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text31">
                        Ensure adherence to GMP and FDA regulations by
                        establishing robust data governance frameworks and
